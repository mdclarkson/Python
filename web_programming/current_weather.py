...
def current_weather(location: str) -> list[dict]:
    ...
    if OPENWEATHERMAP_API_KEY:
        ...
        response_openweathermap = safe_requests.get(OPENWEATHERMAP_URL_BASE, params=params_openweathermap
        )
    ...
    if WEATHERSTACK_API_KEY:
        ...
        response_weatherstack = safe_requests.get(WEATHERSTACK_URL_BASE, params=params_weatherstack
        )
